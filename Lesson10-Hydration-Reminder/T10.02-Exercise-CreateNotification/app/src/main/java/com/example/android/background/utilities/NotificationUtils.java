...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_NOTIFICATION_ID =4010;
    ...
    public static void remindUserBecauseCharching(Context context){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            mChannel = new NotificationChannel(
                    WATER_REMINDER_NOTIFICATION_CHANEL_ID,
